            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide main-slider__slide">
                    <div class="main-slider__slide-bg mobile bg-bg-bg">
                        <picture class="picture">
                            <source type="image/webp" srcset="<?=$arItem['MOBILE']['SRC']?>"><img class="picture__img" src="<?=$arItem['MOBILE']['SRC']?>">
                        </picture>
                    </div>
                    <div class="main-slider__content">
                        ...
                        <div class="main-slider__content-desk"><? echo $arItem["PREVIEW_TEXT"]; ?></div>
                        <div class="main-slider__content-bot" data-swiper-parallax="-2500">
                            <a class="main-slider__content-button btn-hover_parent" href="<?= $arItem['PROPERTIES']['LINK']['VALUE']; ?>">
                                <div class="btn-hover_circle white"></div>
                                <p>Подробнее</p>
