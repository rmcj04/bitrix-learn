...
<div class="swiper-wrapper">
    <?foreach($arResult['ITEMS'] as $arItem):?>
        ...
        ?>
        <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="swiper-slide main-news__card">
            <div class="main-news__card-img">
                ...
                </picture><span class="main-news__card-plug"><?= $arResult['SECT_INFO'][$arItem['IBLOCK_SECTION_ID']]['NAME'] ?></span>
            </div>
